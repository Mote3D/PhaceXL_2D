...
Run phaceXL_2D as '*phaceXL_2D.py -i INPUTFILENAME -c CENTROIDFILENAME -p MPER -s SFACTOR*' from the command line. The following input parameters have to be specified:

1. *INPUTFILENAME*:    name of the file containing the polycrystal microstructure mesh and the cohesive elements generated by    
