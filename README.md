...
![Exemplary 2D polycrystal mesh segment](docs/example.jg "Exemplary 2D polycrystal mesh segment with finite-thickness interface elements at grain boundaries")
